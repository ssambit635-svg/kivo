 ...
 *
 * NOTE (medical-safety): the "typical adult range" values below are
 * prototype defaults for demo purposes only — when a report carries its
 * own reference range, THAT range always wins. These are typical values,
 * not medical truth, and are intentionally conservative.
 */
