...
export const GENERATED_ALIAS_ADDITIONS = {
  ...
  calculated_free_testosterone: ['free testosterone', 'fai'],
  ...
  uric_acid: ['ua'],
  c3: ['c3', 'c3 complement', 'complement c3'],
  c4: ['c4', 'c4 complement', 'complement c4'],
  c2: ['c2', 'c2 complement', 'complement c2'],
  c5: ['c5', 'c5 complement'],
  c6: ['c6', 'c6 complement'],
  '5_nucleotidase': ['5 nucleotidase', "5' nucleotidase"],
  beta_2_microglobulin: ['b2m', 'beta 2 microglobulin'],
